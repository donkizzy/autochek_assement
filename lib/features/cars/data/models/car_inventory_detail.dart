class CarInventoryDetail {
  ...
  factory CarInventoryDetail.fromJson(Map<String, dynamic> json) => CarInventoryDetail(
    ...
    financingSettings: json["financingSettings"] == null ? null : FinancingSettings.fromJson(json["financingSettings"]),
...
class InspectorDetails {
  ...
  factory InspectorDetails.fromJson(Map<String, dynamic> json) => InspectorDetails(
    inspectedMakes: json["inspectedMakes"] == null ? [] : List<InspectedMake>.from(json["inspectedMakes"]!.map((x) => InspectedMake.fromJson(x))),
